        ...
        <nav className="px-[2vw] h-full flex justify-between items-center">
            ...
            <div className="flex justify-center items-center h-full">
                ...
                {auth.auth == null && (
                    <>
                        <div className="pl-4">
                            <a href="https://discord.com/oauth2/authorize?client_id=1312790483314933802&response_type=code&redirect_uri=localhost%3A5173%2Fauth%2Fdiscord&scope=identify+guilds+email+guilds.join">
